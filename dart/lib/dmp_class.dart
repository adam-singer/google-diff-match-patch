    ...
    while (pointer < diffs.length) {
      ...
      case DIFF_EQUAL:
        ...
        if (count_delete >= 1 && count_insert >= 1) {
          ...
          int end = start + count_delete + count_insert;
          diffs.removeRange(start, end);
  ...
  String _diff_linesToCharsMunge(String text, List<String> lineArray,
    ...
    while (lineEnd < text.length - 1) {
      ...
      if (lineHash.containsKey(line)) {
        ...
        chars.write(new String.fromCharCodes([lineArray.length - 1]));
      }
    }
            ...
            for (Diff aDiff in aPatch.diffs) {
              if (aDiff.operation != DIFF_EQUAL) {
                ...
                if (aDiff.operation == DIFF_INSERT) {
                  ...
                  text_buffer
                      ..write(text.substring(0, start_loc + index2))
                      ..write(text.substring(start_loc + diff_xIndex(diffs,
